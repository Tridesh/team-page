...
//     useEffect(() => {
//         const intervalId1 = startScrolling(scrollSectionRef1.current, setViewedPercentage1);
//         const intervalId2 = startScrolling(scrollSectionRef2.current, setViewedPercentage2);
...
const Home = () => {
    ...
    const handleMouseEnter = (intervalId) => {
        if (intervalId) clearInterval(intervalId);
    };

    const handleMouseLeave = (scrollSection, setViewedPercentage, setIntervalId) => {
        startScrolling(scrollSection, setViewedPercentage, setIntervalId);
    };
